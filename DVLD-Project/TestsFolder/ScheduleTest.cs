...
using static DVLD_BusinessAccess.clsTestType;
...
namespace DVLD_Project.Resources
{
    public partial class ScheduleTest : Form
    {
        ...
        public ScheduleTest(int LocalDrivingLicenseApplicationID, clsTestType.enTestType TestTypeID, int AppointmentID = -1)
        {
        ...
        public void LoadInfo(int LocalDrivingLicenseApplicationID)
        {
            ...
            {
                clsUtil.myMessage("Error: No Local Driving License Application with ID = "+ _LocalDrivingLicenseApplicationID ,false);
        ...
        private bool _LoadTestAppointmentData()
        {
            ...
            {
                clsUtil.myMessage("Error: No Appointment with ID = " + _TestAppointmentID.ToString(), false);
                btnSave.Visible = false;
                return false;
            }
        ...
        private bool _HandleRetakeApplication()
        {
            ...
            if (_Mode == enMode.AddNew && _CreationMode == enCreationMode.RetakeTestSchedule)
            {
                ...
                if (!Application.Save())
                {
                    ...
                    clsUtil.myMessage("Faild to Create application", false);
                    return false;
                }
        ...
        {
            LoadInfo(_LocalDrivingLicenseApplicationID);
        }
    }
}
